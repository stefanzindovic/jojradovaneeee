                ...
                <div class="card bg-secondary border border-soft mb-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="pb-5">
                            ...
                            <h4 class="text-center text-gray pt-1">Reset šifre</h4>
                        </div>
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="form-group mb-3">
                                <div class="input-group input-group-merge input-group-alternative">
                                    ...
                                    <input name="email" class="form-control" placeholder="Email" value="{{ old('email') }}" type="email">
                                </div>
                                @error('email')
                                <div class="mb-2">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-premium my-4">Pošalji link za reset šifre</button>
                            </div>
                        </form>
                    </div>
                </div>
