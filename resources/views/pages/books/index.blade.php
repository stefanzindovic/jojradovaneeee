...
@section('page_content')
    {{-- Modal --}}
    <div class="modal fade" id="deleteSingleBook" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            @foreach ($books as $book)
                                <tr style="white-space: pre-line;">
                                    ...
                                    <td class="small">
                                        ...
                                        Rezervisano: <a class="text-purple"
                                            href="{{ route('books.reservations', ['books' => $book->id]) }}">{{ ($reservedBooksPendingCount[$book->id] ?? 0) + ($reservedBooksActiveCount[$book->id] ?? 0) ?? 0 }}</a><br>
                                        Izdato: <a class="text-purple"
                                            href="{{ route('books.issues.issues', ['books' => $book->id]) }}">{{ $issuedBooksCount[$book->id] ?? 0 }}</a><br>
                                        U prekoračenju: <a class="text-purple"
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="{{ route('books.issues.writeoffmultiple', $book->id) }}">
                                                        <svg class="dropdown-icon text-gray-400 me-2"
                                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="{{ route('books.issues.issuebook', $book->id) }}">
                                                        <svg class="dropdown-icon text-gray-400 me-2"
                                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                            viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd"
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="{{ route('books.issues.returnmultiple', $book->id) }}">
                                                        <svg class="dropdown-icon text-gray-400 me-2"
                                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                            viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd"
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="{{ route('books.reservations.reservePage', $book->id) }}">
                                                        <svg class="dropdown-icon text-gray-400 me-2"
                                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                ...
                                                <li>
                                                    <a type="button" class="dropdown-item"
                                                        data-book-id='{{ $book->id }}' href="#"
                                                        onclick="pullDeleteBookModal(this)">
