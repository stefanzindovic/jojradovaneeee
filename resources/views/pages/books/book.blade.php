                                ...
                                <tbody class="bg-white">
                                    @foreach ($issuedRecords as $record)
                                        <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                            ...
                                            <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                                                <x-current-holding start_date="{{ $record->activeAction->action_start }}"
                                                    deadline_date="{{ $record->activeAction->action_deadline }}">
                                                </x-current-holding>
                                            </td>
                                            <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                                ...
                                <tbody class="bg-white">
                                    @foreach ($booksWithBreachDeadline as $record)
                                        <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                            ...
                                            <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                                                <x-breached-days start_date="{{ $record->activeAction->action_start }}"
                                                    deadline_date="{{ $record->activeAction->action_deadline }}">
                                                </x-breached-days>
                                            </td>
                                            <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                                                ...
                                                <div>
                                                    <x-current-holding
                                                        start_date="{{ $record->activeAction->action_start }}"
                                                        deadline_date="{{ $record->activeAction->action_deadline }}"
                                                        indicator="false">
                                                    </x-current-holding>
                                                </div>
