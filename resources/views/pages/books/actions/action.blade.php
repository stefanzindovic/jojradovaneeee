...
@section('interaction')
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group ms-2 me-2">
            ...
            <a href="{{ route('books.issues', $book->id) }}" type="button" class="btn btn-sm btn-outline-primary">Izdaj</a>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="mb-4">
                    ...
                    <p class="p"><a class="link-info" href="{{ route('librarians.show', $action->librarian->id) }}">{{ $action->librarian->name }}</a></p>
                </div>
                <div class="mb-4">
                    <label class="text-gray-400">UČENIK</label>
                    <p class=""><a class="link-info" href="{{ route('students.show',$action->book->student->id) }}">{{ $action->book->student->name }}</a></p>
                </div>
            </div>
        </div>
    </div>
