...
@section('page_content')
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-link active" id="osnovniDetalji" data-bs-toggle="tab" href="#osnovniDetalji-tab" role="tab"
                aria-controls="osnovniDetalji" aria-selected="true">Osnovni detalji</a>
            <a class="nav-link" id="specifikacije" data-bs-toggle="tab" href="#specifikacije-tab" role="tab"
                aria-controls="specifikacije" aria-selected="false">Specifikacije</a>
            <a class="nav-link" id="multimedija" data-bs-toggle="tab" href="#multimedija-tab" role="tab"
                aria-controls="nav-contact" aria-selected="false">Multimedija</a>
        </div>
    </nav>
    <div class="card card-body border-0 shadow mb-4">
        <form id="bookEditForm" action="{{ route('books.update', $book->id) }}" method="POST"
            enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <meta name="csrf-token" content="{{ csrf_token() }}">
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="osnovniDetalji-tab" role="tabpanel"
                    aria-labelledby="osnovniDetalji">
                    <section>
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select required class="form-control" id="bookCategories" name="categories[]"
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" required id="bookGenres" name="genres[]"
                                        multiple="multiple" multiple>
                                        @php
                                            $genreIds = [];
                                ...
                                <div class="mb-3">
                                    ...
                                    <select required class="form-control" required id="bookAuthors" name="authors[]"
                                        multiple="multiple" multiple>
                                        @php
                                            $authorIds = [];
                                ...
                                <div class="mb-3">
                                    ...
                                    <select required class="form-control" name="publisher" id="bookPublisher"
                                        id="bookPublishers">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" required name="published_at" min="1800"
                                        value="{{ old('title', $book->published_at) }}" id="bookPublishedAt"
                                        class="form-control">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required min="1" max="999"
                                        value="{{ old('title', $book->total_copies) }}" type="number"
                                        name="total_copies" id="bookCopies" class="form-control">
                ...
                <div class="tab-pane fade hidden" id="specifikacije-tab" role="tabpanel"
                    aria-labelledby="specifikacije">
                    <section>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" minlength="1" maxlength="4"
                                        value="{{ old('title', $book->total_pages) }}" name="total_pages" id="bookPages"
                                        class="form-control" onkeydown="clearErrorsBrStrana()" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <select required class="form-control" name="script" id="bookScript">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select required class="form-control" name="language" id="bookLanguage">
                                        <option selected></option>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <select required class="form-control" name="cover" id="bookCover"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select required class="form-control" name="format" id="bookFormat"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required minlength="13" maxlength="13" type="text" name="isbn"
                                        id="bookIsbn" class="form-control" value="{{ old('title', $book->isbn) }}"
                            ...
                            <div class="w-9/12 mx-auto bg-white rounded p7 mt-[40px] mb-[150px]">
                                <div x-data="dataFileDnD()"
                                    ...
                                    <div x-ref="dnd"
                                        ...
                                        <input id="multimediaInput" name="pictures[]" accept="image/*" type="file"
                                            multiple
    ...
    @section('scripts')
        <script>
            let elementi = ["bookCategories", "bookGenres", "bookAuthors", "bookPublishers", "bookScript", "bookLanguage",
                "bookCover", "bookFormat"
            ]
