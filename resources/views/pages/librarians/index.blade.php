...
@section('page_content')
    {{-- Modal --}}
    <div class="modal fade" id="deleteSingleLibrarian" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <table id="myTable" class="table user-table table-hover align-items-center" style="width:100%">
                        ...
                        <tbody class="align-middle">
                            @foreach ($librarians as $librarian)
                                <tr>
                                    <td><input type="checkbox" id="checkbox" name="id[]" value="{{ $librarian->id }}"
                                        ...
                                        <a href="{{ route('librarians.show', $librarian->id) }}"
                                            ...
                                            <div class="d-block"><span class="fw-bold">{{ $librarian->name }}</span>
                                                <div class="small text-gray"><span
                                                        class="__cf_email__">{{ $librarian->email }}</span>
                                                </div>
                                            </div>
                                        </a>
                                    </td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item"
                                                        href="{{ route('librarians.show', $librarian->id) }}">
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="{{ route('librarians.edit', $librarian->id) }}">
                                                        <svg class="dropdown-icon text-gray-400 me-2"
                                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                ...
                                                <li>
                                                    <a type="button" class="dropdown-item"
                                                        data-librarian-id='{{ $librarian->id }}' href="#"
                                                        onclick="pullDeleteLibrarianModal(this)">
