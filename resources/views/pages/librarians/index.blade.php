...
@section('interaction')
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{route('librarians.create')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('librarians.show', $librarian->id)}}" class="d-flex align-items-center">
                                    ...
                                    <div class="d-block"><span class="fw-bold">{{ $librarian->name }}</span>
                                        <div class="small text-gray"><span class="__cf_email__">{{ $librarian->email }}</span>
                                        </div>
                                    </div>
                                </a>
                            </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    <div class="btn btn-link text-dark dropdown-toggle dropdown-toggle-split m-0 p-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="icon icon-xs"  viewBox="0 0 20 20">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z"/>
                                        </svg>
                                    </div>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{route('librarians.show', $librarian->id)}}">
                                        ...
                                        <li><a class="dropdown-item" href="{{route('librarians.edit', $librarian->id)}}">
                                                <svg class="dropdown-icon text-gray-400 me-2" xmlns="http://www.w3.org/2000/svg" fill="currentColor"  viewBox="0 0 16 16">
                                        ...
                                        <li>
                                            <a type="button" class="dropdown-item" data-bs-toggle="modal" href="#deleteBook{{$librarian->id}}">
                                    ...
                                    {{--Modal--}}
                                    <div class="modal fade" id="deleteBook{{$librarian->id}}" tabindex="-1" role="dialog" aria-hidden="true">
