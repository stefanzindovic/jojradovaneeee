...
@section('page_content')
    ...
    <div class="card card-body border-0 shadow mb-4">
        <form id="myForm" class="form" action="{{route('librarians.update', $librarian->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="row">
                    ...
                    <div class="div">
                        ...
                        <label class="border border-gray-300 d-flex justify-content-center relative" style="max-height: 350px;max-width: 350px">
                            <div id="empty-cover-art" class="overflow-hidden">
                                <img src="{{$librarian->picture !== 'profile-picture-placeholder.jpg' ? asset('storage/uploads/librarians/' . $librarian->picture) : asset('imgs/' . $librarian->picture)}}" style="object-fit: fill;cursor:pointer;min-height: 350px;width: 350px" class="w-full h-full" id="image-output" alt="Avatar">
