            ...
            <div class="heading">
                <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
                    ...
                    <div class="pt-[24px] pr-[30px]">
                        ...
                        <a href="{{route('librarians.edit', $librarian->id)}}" class="hover:text-blue-600 inline ml-[20px] pr-[10px]">
                ...
                <div class="flex flex-row">
                    <div class="mr-[30px]">
                        ...
                        <div class="mt-[40px]">
                            ...
                            <p class="font-medium">@if($librarian->logins->isNotEmpty()) {{ $librarian->logins[$librarian->logins->count() - 1]->created_at->diffForHumans() }} @else Nikada se nije ulogovao @endif</p>
                        </div>
            ...
            <form class="forma">
                <div class="flex flex-col px-[30px] py-[30px]">
                    <div class="flex flex-col pb-[30px]">
                        ...
                        <input class="h-[40px] px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" type="password" name="password" id="resetLibrarianPassword">
                    </div>
                    <div class="flex flex-col pb-[30px]">
                        <span>Ponovi šifru <span class="text-red-500">*</span></span>
                        <input class="h-[40px] px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" type="password" name="password_confirmation" id="resetLibrarianPasswordConfirm">
                    </div>
                </div>
