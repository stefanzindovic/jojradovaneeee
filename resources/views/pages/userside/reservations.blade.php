                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="media align-items-center mb-1 mt-1">
                                                ...
                                                <div class="media-body">
                                                    <a href="{{route('knjige.show', $pendingRes->book->id)}}" target="_blank">
                                                        <span class="name mb-0 text-sm">{{$pendingRes->book->title}}</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </th>
                                        ...
                                        <td>
                                            <form action="{{ route('rezervacija.otkazi', $pendingRes->id) }}"
                                                ...
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit" class="btn btn-outline-danger btn-sm">Otkaži</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="media align-items-center mb-1 mt-1">
                                                ...
                                                <div class="media-body">
                                                    <a href="{{route('knjige.show', $activeRes->book->id)}}" target="_blank">
                                                        <span class="name mb-0 text-sm">{{$activeRes->book->title}}</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </th>
