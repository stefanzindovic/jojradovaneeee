        ...
        <section id="profile" class="values">
            ...
            <div class="container-xxl" data-aos="fade-up">
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <form id="myForm" action="{{ route('profil.update', Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="pl-lg-4">
                                    <div class="row">
                                        <div class="col-lg-12 d-flex justify-content-center">
                                            <div class="form-group text-center">
                                                ...
                                                <div class="text-center">
                                                    <button type="button" class="btn btn-outline-danger btn-sm pt-2 pb-2" onclick="$('#image-output'). attr('src','/imgs/profile-picture-placeholder.jpg');$('[name=\'picture\']').remove()">Ukloni fotografiju</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
