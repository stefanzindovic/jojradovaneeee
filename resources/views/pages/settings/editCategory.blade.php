                    ...
                    <div class="div">
                        ...
                        <label class="border border-gray-300 d-flex justify-content-center relative"
                            ...
                            <div id="empty-cover-art" class="overflow-hidden">
                                <img src="{{ $category->picture !== 'placeholder.png' ? asset('storage/uploads/categories/' . $category->picture) : asset('imgs/' . $category->picture) }}"
                        ...
                        <div class="text-center">
                            <a class="btn btn-outline-danger btn-sm pt-2 pb-2"
                                onclick="$('#image-output'). attr('src','/imgs/placeholder.png');$('[name=\'picture\']').remove(); destroyImage();">Ukloni
                                fotografiju</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class=" mb-3">
                            <div>
                                ...
                                <input name="title" value="{{ $category->title }}" placeholder="Naziv" type="text"
