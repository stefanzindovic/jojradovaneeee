                ...
                <div class="flex flex-row ml-[30px]">
                    <div class="w-[50%] mb-[100px]">
                        <div class="mt-[20px]">
                            ...
                            <input id="categoryTitle" required minlength="4" maxlength="50" value="{{ old('title', $category->title) }}" type="text" name="title"
                        ...
                        <div class="mt-[20px]">
                            ...
                            <textarea required minlength="10" maxlength="512" id="categoryDescription" name="description" rows="10"
