...
@section('page_content')
    {{-- Modal --}}
    <div class="modal fade" id="deleteSinglePublisher" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    @foreach ($publishers as $publisher)
                                        <tr>
                                            <td><input type="checkbox" id="checkbox" name="id[]"
                                                    value="{{ $publisher->id }}" class="form-check-input"></td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('settings.publishers.edit', $publisher->id) }}">
                                                        ...
                                                        <li>
                                                            <a type="button" class="dropdown-item"
                                                                data-publishers-id='{{ $publisher->id }}' href="#"
                                                                onclick="pullDeletePublisherModal(this)">
