...
@section('interaction')
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{route('settings.genres.create')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <div class="col-md-2">
            <div class="mb-2">
                <div class="row py-2 px-2 mx-1 rounded  hoverItem">
                    <a href="{{route('settings.policies.index')}}" class="hoverText nav-link rounded-3">
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table" style="width:100%">
                            ...
                            @foreach ($genres as $genre)
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{route('settings.genres.edit', $genre->id)}}">
                                                ...
                                                <li>
                                                    <a type="button" class="dropdown-item" data-bs-toggle="modal" href="#delete{{$genre->id}}">
                                ...
                                <div class="modal fade" id="delete{{$genre->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-md-5">
                                                ...
                                                <form class="mb-0" action="{{ route('settings.genres.destroy', $genre->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="d-grid">
