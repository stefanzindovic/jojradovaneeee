...
@section('page_content')
    {{-- Modal --}}
    <div class="modal fade" id="deleteSingleGenre" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    @foreach ($genres as $genre)
                                        <tr>
                                            <td><input type="checkbox" id="checkbox" name="id[]"
                                                    value="{{ $genre->id }}" class="form-check-input"></td>
                                            <td>
                                                {{ $genre->title }}
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('settings.genres.edit', $genre->id) }}">
                                                        ...
                                                        <li>
                                                            <a type="button" class="dropdown-item"
                                                                data-genres-id='{{ $genre->id }}' href="#"
                                                                onclick="pullDeleteGenresModal(this)">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body px-md-5">
                                                        ...
                                                        <p class="text-center mb-4">Da li ste sigurni?</p>
                                                        <form class="mb-0"
                                                            action="{{ route('settings.genres.destroy', $genre->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                            <div class="d-grid">
