...
@section('page_content')
    {{-- Modal --}}
    <div class="modal fade" id="deleteSingleCover" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    @foreach ($covers as $cover)
                                        <tr>
                                            <td><input type="checkbox" id="checkbox" name="id[]"
                                                    value="{{ $cover->id }}" class="form-check-input"></td>
                                            <td>{{ $cover->name }}</td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('settings.covers.edit', $cover->id) }}">
                                                        ...
                                                        <li>
                                                            <a type="button" class="dropdown-item"
                                                                data-covers-id='{{ $cover->id }}' href="#"
                                                                onclick="pullDeleteCoversModal(this)">
