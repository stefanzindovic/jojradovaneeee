...
@section('interaction')
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{route('settings.covers.create')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{route('settings.covers.edit', $cover->id)}}">
                                                ...
                                                <li>
                                                    <a type="button" class="dropdown-item" data-bs-toggle="modal" href="#delete{{$cover->id}}">
                                            ...
                                            {{--Modal--}}
                                            <div class="modal fade" id="delete{{$cover->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body px-md-5">
                                                            ...
                                                            <form class="mb-0" action="{{ route('settings.covers.destroy', $cover->id) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="d-grid">
