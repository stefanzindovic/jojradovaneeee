                    ...
                    <div class="row">
                        <div class=" mb-3">
                            <div>
                                ...
                                <input  type="text" value="{{old('name')}}" required minlength="4" maxlength="50" name="name" id="scriptName" class="form-control">
                                @error('name')
            ...
            <div class="row">
                <div class="col">
                    <div class="float-end">
                        ...
                        <button id="saveScriptBtn" type="submit" class="btn btn-primary">Kreiraj</button>
                    </div>
                </div>
            </div>
        </form>
