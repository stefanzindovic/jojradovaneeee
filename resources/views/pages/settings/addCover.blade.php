...
@section('page_content')
    ...
    <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
        ...
        <div class="scroll height-content section-content">
            <form method="POST" action="{{route('settings.covers.store')}}">
                @csrf
                ...
                <div class="flex flex-row ml-[30px]">
                    <div class="w-[50%] mb-[150px]">
                        <div class="mt-[20px]">
                            ...
                            <input type="text" value="{{old('name')}}" required minlength="4" maxlength="50" name="name" id="coverName" class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]"/>
                        </div>
                        @error('name')
