...
@section('page_content')
    {{-- Modal --}}
    <div class="modal fade" id="deleteSingleFormat" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    @foreach ($formats as $format)
                                        <tr>
                                            <td><input type="checkbox" id="checkbox" name="id[]"
                                                    value="{{ $format->id }}" class="form-check-input"></td>
                                            <td>{{ $format->name }}</td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('settings.formats.edit', $format->id) }}">
                                                        ...
                                                        <li>
                                                            <a type="button" class="dropdown-item"
                                                                data-formats-id='{{ $format->id }}' href="#"
                                                                onclick="pullDeleteFormatsModal(this)">
