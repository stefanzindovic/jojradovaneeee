...
@section('page_content')
    {{-- Modal --}}
    <div class="modal fade" id="deleteSingleLanguage" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    @foreach ($languages as $language)
                                        <tr>
                                            <td><input type="checkbox" id="checkbox" name="id[]"
                                                    value="{{ $language->id }}" class="form-check-input"></td>
                                            <td>{{ $language->name }}</td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('settings.languages.edit', $language->id) }}">
                                                        ...
                                                        <li>
                                                            <a type="button" class="dropdown-item"
                                                                data-language-id='{{ $language->id }}' href="#"
                                                                onclick="pullDeleteLanguageModal(this)">
