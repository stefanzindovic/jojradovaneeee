...
@section('interaction')
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{route('settings.languages.create')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="mb-2">
                <div class="row py-2 px-2 mx-1 rounded  hoverItem">
                    <a href="{{route('settings.policies.index')}}" class="hoverTexte nav-link rounded-3">
        ...
        <div class="col-md-10">
            <div class="row bg-white py-2 px-2 mx-1 rounded">
                <form action="{{route('language.destroyMultiple')}}" id="multiDeleteForm" method="POST">
                    @csrf
                    @method('DELETE')
                    <div class="col">
                    <div class="table-responsive">
                        <table id="myTable" class="table" style="width:100%">
                            ...
                            <tr>
                                <th>
                                    @if(!$languages->isEmpty())<input type="checkbox" id="checkAll" class="form-check-input checkbox"> @endif
                                </th>
                                <th>Naziv jezika</th>
                                <th>Akcija</th>
                            </tr>
                            ...
                            @foreach ($languages as $language)
                                <tr>
                                    <td><input type="checkbox" id="checkbox" name="id[]" value="{{$language->id}}" class="form-check-input"></td>
                                    <td>{{ $language->name }}</td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{route('settings.languages.edit', $language->id)}}">
                                                ...
                                                <li>
                                                    <a type="button" class="dropdown-item" data-bs-toggle="modal" href="#delete{{$language->id}}">
                                            ...
                                            {{--Modal--}}
                                            <div class="modal fade" id="delete{{$language->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body px-md-5">
                                                            ...
                                                            <form class="mb-0" action="{{ route('settings.languages.destroy', $language->id) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="d-grid">
