...
@section('interaction')
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{ route('settings.categories.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
...
@section('page_content')
    {{-- Modal --}}
    <div class="modal fade" id="deleteSingleCategory" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    @foreach ($categories as $category)
                                        <tr>
                                            <td><input type="checkbox" id="checkbox" name="id[]"
                                                    value="{{ $category->id }}" class="form-check-input"></td>
                                            <td>
                                                @if (!$category->picture == null)
                                                    <img class="profpic rounded-circle"
                                                        src="{{ $category->picture !== 'placeholder.png' ? asset('storage/uploads/categories/' . $category->picture) : asset('imgs/' . $category->picture) }}"
                                                        alt="Ikonica" />
                                                @endif
                                                {{ $category->title }}
                                            </td>
                                            <td style="white-space: pre-line;">{{ $category->description }}</td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('settings.categories.edit', $category->id) }}">
                                                        ...
                                                        <li>
                                                            <a type="button" class="dropdown-item"
                                                                data-categories-id='{{ $category->id }}' href="#"
                                                                onclick="pullDeleteCategoryModal(this)">
