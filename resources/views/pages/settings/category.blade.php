                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{route('settings.categories.edit', $category->id)}}">
                                                ...
                                                <li>
                                                    <a type="button" class="dropdown-item" data-bs-toggle="modal" href="#delete{{$category->id}}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body px-md-5">
                                                            ...
                                                            <form class="mb-0" action="{{ route('settings.categories.destroy', $category->id) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="d-grid">
