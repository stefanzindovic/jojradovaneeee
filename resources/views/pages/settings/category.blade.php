                            ...
                            <tr class="w-full hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                ...
                                <td class="flex flex-row items-center px-4 py-4">
                                    <div style="width: 45px; height: 45px;" class="rounded-full">
                                        <img style="border-radius: 100%" class="w-full h-full" src="{{$category->picture !== 'profile-picture-placeholder.jpg' ? asset('storage/uploads/categories/' . $category->picture) : asset('imgs/' . $category->picture)}}" alt="Ikonica">
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                            ...
                                            <div class="py-1">
                                                ...
                                                <form onSubmit="if(!confirm('Da li ste sigurni da želite da obrišete ovu kategoriju?')){return false;}" method="POST" action="{{route('settings.categories.destroy', $category->id)}}">
                                                    @csrf
                                                    @method('DELETE')
