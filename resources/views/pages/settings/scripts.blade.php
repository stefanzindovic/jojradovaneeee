...
@section('interaction')
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="{{route('settings.scripts.create')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="row bg-white py-2 px-2 mx-1 rounded">
                <form action="{{route('script.destroyMultiple')}}" id="multiDeleteForm" method="POST">
                    @csrf
                    @method('DELETE')
                    <div class="col">
                    <div class="table-responsive">
                        <table id="myTable" class="table" style="width:100%">
                            ...
                            <tr>
                                <th>
                                    @if(!$scripts->isEmpty())<input type="checkbox" id="checkAll" class="form-check-input checkbox"> @endif
                                </th>
                                <th>Naziv pisma</th>
                                <th>Akcija</th>
                            </tr>
                            ...
                            @foreach ($scripts as $script)
                                <tr>
                                    <td><input type="checkbox" id="checkbox" name="id[]" value="{{$script->id}}" class="form-check-input"></td>
                                    <td>{{ $script->name }}</td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{route('settings.scripts.edit', $script->id)}}">
                                                ...
                                                <li>
                                                    <a type="button" class="dropdown-item" data-bs-toggle="modal" href="#delete{{$script->id}}">
                                            ...
                                            {{--Modal--}}
                                            <div class="modal fade" id="delete{{$script->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body px-md-5">
                                                            ...
                                                            <form class="mb-0" action="{{ route('settings.scripts.destroy', $script->id) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="d-grid">
