...
@section('page_content')
    ...
    <div class="card card-body border-0 shadow mb-4">
        <form id="myForm" class="form" action="{{route('students.update', $student->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="row">
                    ...
                    <div class="div">
                        ...
                        <label class="border border-gray-300 d-flex justify-content-center relative" style="max-height: 350px;max-width: 350px">
                            <div id="empty-cover-art" class="overflow-hidden">
                                <img src="{{$student->picture !== 'profile-picture-placeholder.jpg' ? asset('storage/uploads/students/' . $student->picture) : asset('imgs/' . $student->picture)}}" style="object-fit: fill;cursor:pointer;min-height: 350px;width: 350px" class="w-full h-full" id="image-output" alt="Avatar">
                ...
                <div class="col-sm">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <div>
                                ...
                                <input minlength="4" maxlength="50" required type="text" name="name" id="librarianName" value="{{ old('name', $student->name) }}" class="form-control" onkeydown="clearErrorsNameUcenikEdit()"/>
                                @error('name')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input minlength="13" maxlength="13" required type="text" name="jmbg" id="librarianJmbg" value="{{old('jmbg', $student->jmbg)}}" class="form-control" onkeydown="clearErrorsJmbgUcenikEdit()">
                            @error('jmbg')
                            <p style="color:red;" id="errorMessageByLaravel"><i
                                    class="fa fa-times"></i> {{ $message }}</p>
                            @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="email" name="email" id="librarianEmail" value="{{ old('email', $student->email) }}" class="form-control" onkeydown="clearErrorsEmailUcenikEdit()">
                        @error('email')
                        <p style="color:red;" id="errorMessageByLaravel"><i
                                class="fa fa-times"></i> {{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input minlength="4" maxlength="18" required type="text" name="username" id="librarianUsername" value="{{old('username', $student->username)}}" class="form-control" onkeydown="clearErrorsUsernameUcenikEdit()">
                        @error('username')
                        <p style="color:red;" id="errorMessageByLaravel"><i
                                class="fa fa-times"></i> {{ $message }}</p>
                        @enderror
