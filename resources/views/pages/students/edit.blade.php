...
@section('page_content')
    ...
    <div class="card card-body border-0 shadow mb-4">
        <form id="form" class="form" action="{{route('students.update', $student->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="row">
                <div class="col-sm">
                    ...
                    <label class="border border-gray-300 rounded d-flex justify-content-center">
                        <div id="empty-cover-art" class="overflow-hidden">
                            <div class="text-center">
                                <img src="{{$student->picture !== 'profile-picture-placeholder.jpg' ? asset('storage/uploads/librarians/' . $student->picture) : asset('imgs/' . $student->picture)}}" style="object-fit: fill;" id="image-output" width="400px" height="400px" alt="Avatar">
