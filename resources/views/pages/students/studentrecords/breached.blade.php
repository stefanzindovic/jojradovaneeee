...
@section('page_title')
    Knjige u prekoračenju | {{$student->name}}
@endsection
    ...
    <div class="col-12 mb-4">
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="mb-2">
                    <div class="row py-2 px-2 mx-1 rounded hoverItem">
                        <a href="{{route('student.reserved', $student->id)}}" class="hoverText nav-link rounded-3">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                ...
                <div class="mb-2">
                    <div class="row py-2 px-2 mx-1 rounded hoverItem">
                        <a href="{{route('student.archivedReservations', $student->id)}}" class="hoverText nav-link rounded-3">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
