<nav id="sidebar"
    ...
    <div class="">
        ...
        <div class="mt-[30px]">
            <ul class="text-[#2D3B48] sidebar-nav">
                <!-- Dashboard Icon -->
                <li class="@if(\Illuminate\Support\Facades\Request::is('dashboards*')) bg-[#EAEAEA] @endif pt-[18px] pb-[14px] mb-[4px] group hover:bg-[#EAEAEA]">
                    <div class="ml-[20px]">
                            ...
                            <div class="transition duration-300 ease-in group-hover:text-[#576cdf]">
                                <a href="dashboard.php" aria-label="Dashboard">
                                    ...
                                    <div class="hidden sidebar-item">
                                        <p class="@if(\Illuminate\Support\Facades\Request::is('dashboards*')) text-[#576cdf] @endif inline text-[15px] ml-[15px]">Komandna tabla</p>
                                    </div>
                                </a>
                            </div>
                        </span>
                ...
                <!-- Bibliotekari Icon -->
                <li class="@if(\Illuminate\Support\Facades\Request::is('librarians*')) bg-[#EAEAEA] @endif pt-[18px] pb-[14px] mb-[4px] group hover:bg-[#EAEAEA] h-[60px]">
                    <div class="ml-[30px]">
                ...
                <!-- Ucenici Icon -->
                <li class="@if(\Illuminate\Support\Facades\Request::is('students*')) bg-[#EAEAEA] @endif pt-[18px] pb-[14px] mb-[4px] group hover:bg-[#EAEAEA] h-[60px]">
                    <div class="ml-[30px]">
                        <span class="flex justify-between w-full whitespace-nowrap">
                            <div>
                ...
                <!-- Knjige Icon -->
                <li class="@if(\Illuminate\Support\Facades\Request::is('books*')) bg-[#EAEAEA] @endif pt-[18px] pb-[14px] mb-[4px] group hover:bg-[#EAEAEA] h-[60px]">
                    <div class="ml-[30px]">
                        <span class="flex justify-between w-full whitespace-nowrap">
                            <div>
                ...
                <!-- Autori Icon -->
                <li class="@if(\Illuminate\Support\Facades\Request::is('authors*')) bg-[#EAEAEA] @endif pt-[18px] pb-[14px] mb-[4px] group hover:bg-[#EAEAEA] h-[60px]">
                    <div class="ml-[30px]">
                        <span class="flex justify-between w-full whitespace-nowrap">
                            <div>
                ...
                <!-- Izdavanje Icon -->
                <li class="@if(\Illuminate\Support\Facades\Request::is('books/authors*')) bg-[#EAEAEA] @endif pt-[18px] pb-[14px] mb-[4px] group hover:bg-[#EAEAEA] h-[60px]">
                    <div class="ml-[30px]">
                        <span class="flex justify-between w-full whitespace-nowrap">
                            <div>
    ...
    <div class="@if(\Illuminate\Support\Facades\Request::is('settings*')) bg-[#EAEAEA] @endif sidebar-nav py-[10px] border-t-[1px] border-[#e4dfdf] pt-[23px] pb-[29px]  group hover:bg-[#EAEAEA]">
        <!-- Settings Icon -->
        <a href="{{route('settings.policies.index')}}" aria-label="Settngs" class="ml-[30px]">
            <span class="whitespace-nowrap">
                ...
                <div class="hidden sidebar-item">
                    <p class="@if(\Illuminate\Support\Facades\Request::is('settings*')) text-[#576cdf] @endif transition duration-300 ease-in group-hover:text-[#576cdf] inline text-[15px] ml-[20px]">
                        Podešavanja</p>
                </div>
            </span>
        </a>
