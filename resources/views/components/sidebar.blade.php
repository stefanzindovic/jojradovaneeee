...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-transparent-1 text-white collapse" data-simplebar>
    <div class="sidebar-inner disablexscroll px-4 pt-3">
        <div
            class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
            <div class="d-flex align-items-center">
                <div class="d-block">
                    <h2 class="h5 mb-3">Zdravo, {{ Auth::user()->name }} {{ Auth::user()->lastname }}</h2>
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="{{ route('dashboard') }}" class="nav-link d-flex align-items-center">
                    <img src="{{asset('imgs/Intelectowhite.png')}}" height="25" alt="Intelecto">
                </a>
            </li>
            ...
            <li class="nav-item  @if (url()->current() == route('librarians.index')) active @endif ">
                <a href="{{ route('librarians.index') }}" class="nav-link">
                    ...
                    <span class="sidebar-text">Bibliotekari</span>
                    </span>
                    <span>
                    </span>
                </a>
            ...
            <li class="nav-item @if (url()->current() == route('students.index')) active @endif">
                <a href="{{ route('students.index') }}" class="nav-link">
                    ...
                    <span class="sidebar-text">Učenici</span>
                </a>
            </li>
            <li class="nav-item ">
            ...
            <li class="nav-item  @if (url()->current() == route('authors.index')) active @endif ">
                <a href="{{ route('authors.index') }}" class="nav-link">
                    ...
                    <span class="sidebar-text">Autori</span>
                    <span>
                    </span>
                </a>
            </li>
            <li class="nav-item  @if (url()->current() == route('books.issues.issues')) active @endif ">
                <a href="{{ route('books.issues.issues') }}" class="nav-link">
                    ...
                    <span class="sidebar-text">Izdavanje Knjiga</span>
                    <span>
                    </span>
                </a>
            </li>
