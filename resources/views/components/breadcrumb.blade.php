    ...
    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
        ...
        @php
            ...
            $seperateThese = [
                ...
                'Action|Akcija',
                'Actions|Akcije',
                'Reservedbooks|Rezervisane knjige',
                'Archivedreservations|Arhivirane rezervacije',
                'Breachedbooks|Knjige u prekoračenju',
                'Returnedbooks|Vraćene knjige',
                'Issuedbooks|Izdate knjige',
                'Book|Knjiga',
            ];
