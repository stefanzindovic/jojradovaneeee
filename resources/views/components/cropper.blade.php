...
<div class="flex flex-col">
    <label class="mt-6 cursor-pointer">
        <div style="width: 220px; height: 220px;" id="empty-cover-art"
            ...
            <div class="py-4">
                <img id="imageOutput" class="absolute w-full h-full bottom-0" @if($picture === 'profile-picture-placeholder.jpg') src="{{asset('imgs/profile-picture-placeholder.jpg')}} @else src="{{asset('storage/uploads/' . $stage . '/' . $picture)}} @endif">
    ...
    @error("picture")
    <p style="color:red; max-width: 220px;" id="errorMessageByLaravel"><i class="fa fa-times  mr-[5px] mt-[10px]"></i> {{ $message }}</p>
    @enderror
