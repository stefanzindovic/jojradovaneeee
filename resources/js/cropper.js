jQuery(document).ready(function () {
    ...
    pictureInput.on('change', function (e) {
        ...
        if (!allowedTypes.includes(uploadedFile.type)) {
            setTimeout(function () {
                pictureValidationMessage.css({"display": "block"}).html('<small class="text-red-500 align-middle"><i class="fa fa-times text-red"></i> Odabrani fajl nije podržanog formata. Molimo vas da odaberete drugu SLIKU.</small>');
            }, 200);
            return e.preventDefault();
        } else if (uploadedFile > 5 * 1024 * 1024) {
            setTimeout(function () {
                pictureValidationMessage.css({"display": "block"}).html('<small class="text-red-500 align-middle"><i class="fa fa-times text-red"></i> Odabrani fajl je prevelik. Molimo vas da odaberete neki manji fajl.</small>');
            }, 200);
            return e.preventDefault();
        } else {
            setTimeout(function () {
